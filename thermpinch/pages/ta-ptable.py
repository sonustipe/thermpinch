...
class PageIDs:
    def __init__(self) -> None:
        ...
        self.outputdata_ptable: Final[str] = f"{prefix}_outputdata_ptable"
        self.runpinch_ptable: Final[str] = f"{prefix}_runpinch_ptable"
...
layout = html.Div(
    [  # html.Div(id="pinch_results", style={"margin-top": "20px"}),
        ...
        html.Br(),
        # html.Div(id="pinch_results", style={"margin-top": "20px"}),
        ButtonCustom(label="Run PyPinch Analysis", id="runpinch_ptable").layout,
        dcc.Loading(
            id="loading", children=[html.Div(id="outputdata_ptable")], type="default"
        ),
    ]
)
...
@app.callback(
    Output("outputdata_ptable", "children"), [Input("runpinch_ptable", "n_clicks")]
)
