...
class PageIDs:
    def __init__(self) -> None:
        ...
        self.outputdata: Final[str] = f"{prefix}_outputdata"
...
layout = html.Div(
    [
        ...
        ButtonCustom(label="Run PyPinch Analysis", id="runpinch").layout,
        dcc.Loading(
            id="loading", children=[html.Div(id="outputdata")], type="default"
        ),
    ]
)


@app.callback(Output("outputdata", "children"), [Input("runpinch", "n_clicks")])
